...
namespace kitty_ecs {
  ...
  void initRenderer(Renderer& renderer, GLFWwindow* window, MeshData& mesh) {
    ...
    instanceAttrs[4].format = WGPUVertexFormat_Float32; // atlas_x, atlas_y
    instanceAttrs[4].offset = 9 * sizeof(float);
    instanceAttrs[4].shaderLocation = 7;
    ...
    renderer.globalsBuffer = globalsBuffer;
  ...
  void destroyRenderer(Renderer& renderer) {
    ...
    wgpuBufferRelease(renderer.globalsBuffer);
